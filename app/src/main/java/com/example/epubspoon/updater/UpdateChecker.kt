package com.example.epubspoon.updater
 ...
 * 无需 token（公开仓库），使用 Android 自带的 HttpURLConnection。
 */
object UpdateChecker {

    private const val TAG = "UpdateChecker"
    private const val API_URL =
        "https://api.github.com/repos/sedationh/EpubSpoon/releases/latest"
    ...
    /**
     * 检查是否有新版本。
     * @param currentVersion 当前应用版本号，如 "1.0"
    ...
    suspend fun check(currentVersion: String): UpdateResult? = withContext(Dispatchers.IO) {
        try {
            ...
            // tag_name 通常是 "v1.0" 或 "1.0"，统一去掉 "v" 前缀
